"""Launch Hold Receipt — SCAFFOLD STUB.

Company lens: Rocket Lab (independent; no affiliation).
Bottleneck: Maintaining one reliable software lifecycle across vehicles, spacecraft, test, simulation, and operations.
...
class LaunchHoldReceipt:
    ...
    - `evaluate(req)` returns a LaunchHoldReceiptReceipt
    ...
    def evaluate(self, req: LaunchHoldReceiptRequest) -> LaunchHoldReceiptReceipt:
        ...
        if reasons:
            ...
            return LaunchHoldReceiptReceipt(
